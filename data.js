const exercisesDB = {
    "Leap Ups": { desc: "Выпрыгивания из полуприседа. Руки вверх при прыжке.", icon: "🚀" },
    "Step Ups": { desc: "Зашагивания на стул/скамью со сменой ног в воздухе.", icon: "🪜" },
    "Thrust Ups": { desc: "Прыжки на прямых ногах, работаем только икрами.", icon: "⚡️" },
    "Burnouts": { desc: "Прыжки на носках (2-3 см) максимально быстро.", icon: "🔥" },
    "Squat Hops": { desc: "Выпрыгивания из полного приседа (только для 15 недели).", icon: "🐸" }
};
