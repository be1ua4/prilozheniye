...
async def generate_ai_workout(height, weight, bg, goal):
    ...
    try:
        ...
        if goal == "Vertical Jump":
            focus_prompt = "Упор на высоту выпрыгивания. Используй плиометрику."
            recommended_exercises = "['Выпрыгивания', 'Запрыгивания на тумбу', 'Глубинные прыжки', 'Пого прыжки', 'Прыжки на икрах']"
        elif goal == "Broad Jump":
            focus_prompt = "Упор на длину прыжка и взрывную силу ног."
            recommended_exercises = "['Прыжок в длину', 'Прыжки в выпаде', 'Зашагивания', 'Болгарские выпады']"
        elif goal == "Athleticism":
            focus_prompt = "Баланс выносливости, силы и баланса."
            recommended_exercises = "['Бёрнауты', 'Пистолетик', 'Болгарские выпады', 'Запрыгивания на тумбу']"
        else:
            focus_prompt = "Общая прыгучесть."
            recommended_exercises = "['Выпрыгивания', 'Бёрнауты', 'Зашагивания']"

        full_list = "['Выпрыгивания', 'Зашагивания', 'Прыжки на икрах', 'Бёрнауты', 'Прыжки из приседа', 'Запрыгивания на тумбу', 'Глубинные прыжки', 'Пого прыжки', 'Прыжок в длину', 'Болгарские выпады', 'Прыжки в выпаде', 'Пистолетик']"

        prompt = (
            f"Роль: Профессиональный тренер по прыжкам. Атлет: {height}см, {weight}кг, Опыт: {bg}.\n"
            f"ЦЕЛЬ: {goal}. {focus_prompt}\n"
            f"Приоритетные упражнения: {recommended_exercises}.\n"
            f"Минимальный объем тренировки: {min_reps} повторений.\n"
            f"Задача: Составь JSON план на 1 тренировку (3-5 упражнений). Выбирай названия СТРОГО из этого списка: {full_list}.\n"
